...
class GreeterSystem:
    ...
    async def send_welcome_message(self, user: discord.User):
        ...
        try:
            ...
            try:
                self.bot.loop.create_task(self._onboarding_followups(user))
            except Exception as e:
                print(f"Error scheduling onboarding follow-ups: {e}")
    ...
    async def _onboarding_followups(self, user: discord.User):
        ...
        try:
            ...
            embed = discord.Embed(
                ...
                description=("Try our new slash commands for a smoother experience!"),
                color=0xFFA500,
                timestamp=datetime.now(),
            )
            embed.add_field(
                name="/feedback", value="Submit feedback directly.", inline=False
            )
            ...
            print(f"Error sending onboarding follow-ups: {e}")
