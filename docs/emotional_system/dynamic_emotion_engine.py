    ...
    def _handle_emotion_transition(self, data):
        ...
        try:
            ...
            if transition_type == "context_switch":
                ...
                result = self.handle_psychologically_realistic_context_switch(
                ...
                result = self.create_psychologically_smooth_transition(
                    from_emotion, to_emotion, context
                )
            elif transition_type == "suggest_transition":
                context = data.get("context", {})
                current_emotion = data.get("current_emotion")
                result = self.suggest_psychologically_realistic_emotion_transition(
    ...
    def _handle_emotion_generation(self, data):
        ...
        try:
            ...
            if generation_type == "realistic_response":
                ...
                result = self.generate_psychologically_realistic_response(
                    user_message, context_switch
                )
