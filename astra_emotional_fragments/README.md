...
The `astra_emotional_fragments/` directory contains the sophisticated emotional system that powers Luna's authentic emotional intelligence. This system features a **global weight calculation** that takes ALL emotions into account, creating dynamic, realistic emotional responses with a dual-release mechanism.

## 🎯 **Core Components**

### **enhanced_emotional_meter.py**
The heart of Luna's emotional system with global weight calculation:
...
Enhanced emotional blending with psychological models:
...
Dynamic emotion adaptation and context switching:
