...
class EnhancedAudioProcessor:
    ...
    def generate_sine_wave(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error generating sine wave: {str(e)}"
            }
            ...
            for effect_name in effects:
                if effect_name in self.audio_effects:
                    ...
                    if effect_name == "reverb":
                        ...
                        # Echo effect
                        echo = audio - 15
                        audio = audio.overlay(echo, position=int(params["delay"] * 1000))
                    
                    elif effect_name == "delay":
                        # Delay effect
                        delay = audio - 20
                        audio = audio.overlay(delay, position=int(params["delay_time"] * 1000))
    ...
    def create_audio_mix(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error creating audio mix: {str(e)}"
            }
